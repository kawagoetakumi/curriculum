...
public final class EmployeeBean {
     ...
     */
    public EmployeeBean(String empId, String password, String name, String mail, String programingLanguage, String comment, String cleateDate, String updateDate) {
        this._empId = empId;
    ...
    public void setCleateDate(String cleateDate) {
        this._cleateDate = cleateDate;
    }

    public String getCleateDate() {
        return _cleateDate;
    }
