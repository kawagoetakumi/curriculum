...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected static final String CONST_ELEMENT_NAME_REQUEST = "requestTypeName";
    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException {
        ...
        try {
        	...
        	EmployeeBean reqEmployeeBean = new EmployeeBean(reqEmpId);
//        	EmployeeManagementService.getEmployeeData( EmployeeDaoFIND_BY_EMPID ,reqEmployeeBean );
        	ems.getEmployeeData(ExecuteCase.FIND_BY_EMPID, reqEmployeeBean);
