...
<link rel="stylesheet" href="MVC_TASK/src/main/webapp/css/common.css">
<link rel="stylesheet" href="MVC_TASK/src/main/webapp/css/login.css">
...
<body>
    ...
    <div class="div-login-form">
        <% if (requestStatus < 2 && !message.isEmpty()) { %>
            ...
            <label class="error_label">パスワードに誤りがあります。:</label>
          <br>
        <% } %>
